...
public final class Connection {
     ...
     */
    public Connection(@NonNull String clientHandle, @NonNull String clientId, @NonNull String host,
                      int port, Context context, @NonNull MqttAndroidClient client, boolean sslConnection) {
     ...
     */
    public static Connection createConnection(@NonNull String clientId, @NonNull String host,
                                              @IntRange(from = 0) int port, @NonNull Context context,
     ...
     */
    public void changeConnectionStatus(@NonNull ConnectionStatus connectionStatus) {
     ...
     */
    public boolean isHandle(@NonNull String handle) {
     ...
     */
    public void addConnectionOptions(@NonNull MqttConnectOptions connectOptions) {
     ...
     */
    public void registerChangeListener(@NonNull PropertyChangeListener listener) {
     ...
     */
    private void notifyListeners(@NonNull PropertyChangeEvent propertyChangeEvent) {
