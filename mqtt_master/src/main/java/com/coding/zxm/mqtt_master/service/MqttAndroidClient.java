 ...
 * android service to actually interface with MQTT server. It provides android applications a simple
 * programming interface to all features of the MQTT version 3.1 specification including:
 * </p>
 * <ul>
 * <li>connect
 * <li>publish
