...
public class MqttService extends Service implements MqttTraceHandler {
     ...
     * @throws IllegalArgumentException thrown if clientHandle is invalid
     */
     ...
     */
    @Override
    public void traceDebug(@NonNull String tag, @NonNull String message) {
     ...
     */
    @Override
    public void traceError(@NonNull String tag, @NonNull String message) {
     ...
     */
    @Override
    public void traceException(@NonNull String tag, @NonNull String message, @NonNull Exception e) {
    ...
    /**
     * Unregister BroadcastReceivers for monitoring the status of a network.
     */
    ...
    private class NetworkConnectionIntentReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            WakeLock wl = null;
            if (pm != null) {
                wl = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "MQTT1234");
                wl.acquire();
            }
